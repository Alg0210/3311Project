...
class TestEquipmentRepository extends org.example.data.CSVRepository {
    ...
    public List<Equipment> getAllEquipment() { return new java.util.ArrayList<>(equipmentList); }

    // Helper method
    public void addEquipmentForRetrieval(Equipment equipment) { equipmentList.add(equipment); }

    // Getters
    public boolean wasEquipmentSaved() { return equipmentSaved; }

    public Equipment getLastSavedEquipment() { return lastSavedEquipment; }

    public int getSaveCount() { return saveCount; }

    public boolean wasEquipmentUpdated() { return equipmentUpdated; }

    public Equipment getLastUpdatedEquipment() { return lastUpdatedEquipment; }

    public boolean wasStatusUpdated() { return statusUpdated; }

    public EquipmentStatus getLastUpdatedStatus() { return lastUpdatedStatus; }

    public void setLastUpdatedStatus(EquipmentStatus status) { this.lastUpdatedStatus = status; }
}
