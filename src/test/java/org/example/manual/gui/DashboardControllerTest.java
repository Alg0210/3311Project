...
class TestDashboardController {
    ...
    public void callHandleHome() { callLoadEquipment(); }

    public void callHandleAccount() { TestMainApp.switchScene("Account"); }

    public void callHandleMyReservations() { TestMainApp.switchScene("MyReservations"); }

    public void callHandleLogout() { TestMainController.logout(); }
...
class DashboardTestEquipmentManager {
    ...
    public List<Equipment> getAvailableEquipment() { return new ArrayList<>(equipmentList); }
}
